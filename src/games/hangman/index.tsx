...
export function HangmanGame({ onInteraction }: GameProps) {
	const [roundWord, setRoundWord] = useState<RoundWord>(() => pickWord())
	...
	const processGuess = useCallback((rawGuess: string) => {
			...
			<div className="grid w-full items-start gap-6 lg:grid-cols-[minmax(0,1fr)_13rem] lg:gap-10">
				<div className="mx-auto w-full max-w-140">
					...
					<div className="relative rounded-2xl border-4 border-foreground bg-card p-3 shadow-lg sm:p-6">
						...
						>
							<line x1="30" y1="230" x2="120" y2="230" stroke="currentColor" strokeWidth="4" strokeLinecap="round" />
							<line x1="60" y1="230" x2="60" y2="20" stroke="currentColor" strokeWidth="4" strokeLinecap="round" />
							<line x1="60" y1="20" x2="150" y2="20" stroke="currentColor" strokeWidth="4" strokeLinecap="round" />
							<line x1="150" y1="20" x2="150" y2="50" stroke="currentColor" strokeWidth="4" strokeLinecap="round" />
				...
				>
					...
					<div className="col-span-2 min-h-6 text-xs font-semibold text-muted-foreground lg:col-span-1">
						{duplicateLetter ? `Already guessed: ${duplicateLetter}` : statusText}
					</div>
